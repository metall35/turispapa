...
export default function TablaContenido(data) {
    ...
    return (
        <TETabsPane show={justifyActive === data.data.categoria} >
            <figure className="relative w-[100%] max-h-[568px] overflow-hidden flex items-center justify-center">
                <img src={data.data.imagen} alt=""
                    className="object-center object-cover h-full w-full min-h-[568px]"
                />
